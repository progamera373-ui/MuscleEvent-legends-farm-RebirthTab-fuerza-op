...
-- VENTANA PRINCIPAL
local window = library:AddWindow("SecretHub| by @alan", {
    main_color = Color3.fromRGB(255, 255, 255), -- dark purple
    min_size = Vector2.new(610, 830),
    can_resize = false,
})

local AutoFarm = window:AddTab("Farm OP...craking")
AutoFarm:Show()
...
Credits:AddLabel("Secrethub")
Credits:AddLabel("Alan alex mi hija")
